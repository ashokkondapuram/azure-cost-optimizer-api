...
def test_filter_known_components_drops_legacy_vmss():
    filtered = filter_known_components(["Virtual Machine Scale Sets", "AKS"])
    assert filtered == ["AKS"]
    assert resolve_batches(["Virtual Machine Scale Sets"]) == []
