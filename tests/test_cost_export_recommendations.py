...
def test_high_spend_rule_skips_savings_plan_orders():
    row = _row(
        ...
        monthlyCostBilling=10950.0,
        properties={"armResourceType": "microsoft.billingbenefits/savingsplanorders"},
    )
    findings = analyze_cost_export_resources("sub-id", [row])
