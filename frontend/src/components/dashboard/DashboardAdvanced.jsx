      ...
      <div className="dashboard-hero__content">
        <div className="dashboard-hero__main">
          ...
          <p className="dashboard-hero__sub">
            {(opt.open_findings ?? 0).toLocaleString()} open recommendations · PostgreSQL-backed data
          </p>
      ...
      <section className="dashboard-actions">
        <div className="card dashboard-panel">
          <header className="dashboard-panel__head">
            ...
            <div>
              <h3 className="dashboard-section__title">Top recommendations</h3>
          ...
          {recs.length === 0 ? (
            <p className="dashboard-panel__empty-text">No open recommendations yet</p>
          ) : (
