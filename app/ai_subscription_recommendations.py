...
- implementation_steps: ordered operational steps to complete each recommendation (4–8 steps when applicable). Each step must be specific, actionable, and grounded in the supplied payload. Use imperative verbs. Include validation and rollback checkpoints for risky changes.
