...
RULE_MANIFEST: dict[str, dict[str, Any]] = {
    ...
    "LOG_ANALYTICS_INGESTION_EXTENDED": {"component": "Monitoring", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "APP_INSIGHTS_SAMPLING_EXTENDED": {"component": "Monitoring", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "APP_INSIGHTS_LOW_TRAFFIC_EXTENDED": {"component": "Monitoring", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    # ── Extended / Integration ─────────────────────────────────────────────
    "APIM_SKU_EXTENDED": {"component": "Integration", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "APIM_LOW_TRAFFIC_EXTENDED": {"component": "Integration", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "DATA_FACTORY_IR_EXTENDED": {"component": "Integration", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "DATA_FACTORY_IDLE_PIPELINES_EXTENDED": {"component": "Integration", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "LOGIC_APP_PLAN_EXTENDED": {"component": "Integration", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "LOGIC_APP_LOW_RUNS_EXTENDED": {"component": "Integration", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    # ── Extended / Messaging ───────────────────────────────────────────────
    "EVENT_HUBS_TIER_EXTENDED": {"component": "Messaging", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "EVENT_HUBS_LOW_THROUGHPUT_EXTENDED": {"component": "Messaging", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "SERVICE_BUS_TIER_EXTENDED": {"component": "Messaging", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "SERVICE_BUS_IDLE_NAMESPACE_EXTENDED": {"component": "Messaging", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    # ── Extended / Analytics ───────────────────────────────────────────────
    "DATABRICKS_CLUSTER_EXTENDED": {"component": "Analytics", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "DATABRICKS_DEV_WORKSPACE_EXTENDED": {"component": "Analytics", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "SYNAPSE_PAUSE_EXTENDED": {"component": "Analytics", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "SYNAPSE_SQL_IDLE_EXTENDED": {"component": "Analytics", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "ADX_INGESTION_EXTENDED": {"component": "Analytics", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "ADX_LOW_INGESTION_EXTENDED": {"component": "Analytics", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "ML_WORKSPACE_COMPUTE_EXTENDED": {"component": "Analytics", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "ML_WORKSPACE_IDLE_EXTENDED": {"component": "Analytics", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    # ── Extended / Backup & Search ─────────────────────────────────────────
    "BACKUP_RETENTION_EXTENDED": {"component": "Backup", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "BACKUP_VAULT_GROWTH_EXTENDED": {"component": "Backup", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "COGNITIVE_SEARCH_SKU_EXTENDED": {"component": "Search", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "COGNITIVE_SEARCH_REPLICA_EXTENDED": {"component": "Search", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    # ── Extended / Networking ──────────────────────────────────────────────
    "NETWORK_FRONT_DOOR_IDLE_EXTENDED": {"component": "Networking", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
    "NETWORK_FRONT_DOOR_COST_EXTENDED": {"component": "Networking", "engine": "extended", "settings": ["min_monthly_savings_usd"]},
