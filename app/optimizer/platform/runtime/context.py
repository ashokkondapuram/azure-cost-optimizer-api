...
class AnalysisContext:
    ...
    advisor_by_resource: dict[str, list[Any]] = field(default_factory=dict)
    global_config: dict[str, Any] = field(default_factory=dict)

    def advisor_for_resource(self, resource_id: str) -> list[Any]:
        return list(self.advisor_by_resource.get((resource_id or "").lower(), []))
