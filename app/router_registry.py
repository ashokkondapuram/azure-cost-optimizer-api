...
from app.routers.savings_tracker import router as savings_router
...
from app.routers.tag_compliance import router as tag_compliance_router
import structlog
