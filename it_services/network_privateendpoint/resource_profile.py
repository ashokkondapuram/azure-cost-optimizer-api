"""Resource profile — owned by network-privateendpoint IT service."""
...
MONITOR_PROFILE = ResourceMonitorProfile(
    ...
    metrics=(
        um("PEBytesIn", "pe_bytes_in", "Private endpoint bytes in", aggregation="Total",
           rules=("PRIVATE_ENDPOINT_UNDERUTILIZED",)),
        um("PEBytesOut", "pe_bytes_out", "Private endpoint bytes out", aggregation="Total",
           rules=("PRIVATE_ENDPOINT_UNDERUTILIZED",)),
    ),
)
