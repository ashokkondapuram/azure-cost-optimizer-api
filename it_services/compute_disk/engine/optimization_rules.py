...
from app.managed_disk_catalog import optimization_thresholds, parse_disk_arm
...
def evaluate_disk_capacity_rightsize(
    ...
    return ComputeFindingDraft(
        ...
        recommendation="Downsize disk to the next smaller SKU tier after confirming growth headroom requirements.",
        savings=savings,
        waste_score=52,
...
def evaluate_disk_queue_depth(
    ...
    return ComputeFindingDraft(
        ...
        recommendation="Investigate I/O patterns before tier downgrade — consider Premium SSD or disk caching improvements.",
        savings=0.0,
        waste_score=64,
