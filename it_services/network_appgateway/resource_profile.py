...
TECHNICAL_FETCH_SPEC = TechnicalFetchSpec(
    ...
    fields=(
        ...
        field("health_probe_count", "computed:health_probe_count", "Health probe count", "association"),
...
MONITOR_PROFILE = ResourceMonitorProfile(
    ...
    metrics=(
        ...
        um("TotalRequests", "request_count", "Total requests served", aggregation="Total",
           rules=("APP_GATEWAY_IDLE_EXTENDED",)),
        um("FailedRequests", "failed_request_count", "Failed requests", aggregation="Total",
           rules=("APP_GATEWAY_IDLE_EXTENDED",)),
